...
BOOL IsURL(LPCTSTR str); //провер€ет €вл€етс€ ли строка путЄм к файлу, ссылкой или ни тем, ни другим
...
#define SIGN_PNG		0x474E5089		//ЙPNG
#define SIGN_JPG_BEGIN	0xD8FF			//—игнатура начала
#define SIGN_JPG_END	0xD9FF			//—игнатура конца
...
// ”добные функции, скрывают возню со структурами и множественные очевидные вызовы
LRESULT ComboBox_GetCurSelData(HWND hCB);
int ComboBox_GetSelByData(HWND hCB, LPARAM cb_data); // выберет первый подход€щий
BOOL ComboBox_SetSelByData(HWND hCB, LPARAM cb_data); // установит выбранным первый подход€щий
...
public:
	...
	virtual BOOL Proceed(LPCTSTR full_file_name, //полный путь к файлу
				LPCTSTR file_name) = 0; // указатель на им€ файла
};
